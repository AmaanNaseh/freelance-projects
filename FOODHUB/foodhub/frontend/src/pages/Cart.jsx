...
export default function Cart() {
  ...
  return (
    <div className="p-6">
        ...
        {cartItems.length > 0 ? (
          cartItems.map((item, index) => (
            ...
            >
              ...
              <Recommendations itemName={item.name} />
            </div>
          ))
        ) : (
      ...
      <button
        onClick={() => navigate("/")}
        className="px-3 py-2 w-fit bg-blue-500 hover:scale-105 transition-all duration-300 rounded-md text-white font-semibold mt-12"
      >
        Back to Menu
      </button>
    </div>
